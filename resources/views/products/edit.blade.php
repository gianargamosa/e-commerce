                ...
                <div class="panel-body">
                    <form method="POST" action="/products/{{ $products->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="product_name" placeholder="Product Name" name="product_name" value="{{ $products->product_name }}">
                        </div>
                        <div class="form-group">
                            <label for="product_description">Product Description</label>
                            <textarea class="form-control" id="product_description" placeholder="Product Description" name="product_description">{{ $products->product_description }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="product_description">Amount</label>
                            <input type="text" class="form-control" id="amount" placeholder="Product Description" name="amount" value="{{ $products->amount }}">
                        </div>
                        <div class="form-group">
